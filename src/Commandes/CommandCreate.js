        ...
        <div style={{ marginLeft: "5px" }}>
            ...
            <div className="col-12 row shadow ml-3 mb-3" style={{marginLeft:"5px",width:"90%"}}>
                ...
                <div className="col-6">
                    ...
                    <input className="col-6 border-light shadow w-75  mb-4" type='text' placeholder="Saisir le nom du client"/>
                </div><br />

                <div className="col-6">
                    <label htmlFor="number">Téléphone (*)</label>  <br/>
                    <input className="col-6 border-light shadow w-75  mb-4" type='number' placeholder="ex:+21260101010"/>
                </div><br/>

                <div className="col-12">
                    <label htmlFor="number">Adresse Livraison (*)</label>  <br/>
                    <input className="col-6 border-light shadow w-75  mb-4" type='text' placeholder="Saisir l'adresse de livraison"/>
                </div><br/>
            ...
            <div className="col-11 row mt-3 justify-content-end border-light shadow ml-3" style={{marginLeft:"10px",marginRight:"20px"}}>
                <button className="col-1 text-light mt-3 mb-3 " style={{border: "none",backgroundColor: "rgb(1, 30, 36)",color: "rgb(248, 252, 252)",marginRight:"20px"}}>Créer</button>
            </div>
